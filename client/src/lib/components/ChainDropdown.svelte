...
<div class="inputs-container">
	...
	<input
		...
		class="input w-full text-sm form-background inter"
		id="network"
		{disabled}
		data-testid="network"
		max="9999"
	...
	{#if !customValue}
		<div class="dropdown dropdown-top md:dropdown-bottom w-full">
			...
			<ul tabindex="0" class="dropdown-content menu p-2 shadow bg-white mt-2 rounded-box w-full">
...
<style lang="postcss">
	...
	.chain-dropdown {
		@apply input w-full text-sm flex flex-col justify-center items-center cursor-pointer border border-gray3;
		background-color: white;
	}
