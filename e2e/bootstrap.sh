...
SMF_BOTBACKEND_FAUCET_ACCOUNT_MNEMONIC="//Alice"
SMF_WEBBACKEND_FAUCET_ACCOUNT_MNEMONIC="//Bob"
...
SMF_BOTBACKEND_PORT=5555
SMF_WEBBACKEND_PORT=5556
SMF_BACKEND_RPC_ENDPOINT="http://polkadot:9933/"
SMF_BACKEND_DEPLOYED_REF=local
SMF_BACKEND_DEPLOYED_TIME=local
SMF_WEBBACKEND_RECAPTCHA_SECRET="6LeIxAcTAAAAAGG-vFI1TnRWxMZNFuojJ4WifJWe" # Public testing secret, will accept all tokens.
EOF
